...
export interface ValidatorJSAsserts {
  ...
  anyOf(...constraintSets: Array<{ [key: string]: AssertInstance | Array<AssertInstance> }>): AssertInstance;
  ...
  oneOf(...constraintSets: Array<{ [key: string]: AssertInstance | Array<AssertInstance> }>): AssertInstance;
