...
exports['default'] = function (threshold, options) {
  ...
  this.validate = function (value) {
    ...
    if (diff >= _this.threshold) {
      throw new _validatorJs.Violation(_this, value, { absolute: _this.absolute, asFloat: _this.asFloat, diff: diff, fromDate: _this.fromDate, threshold: _this.threshold, unit: _this.unit });
    }
